...
export default function Home() {
  ...
  const primaryLabel = useMemo(() => {
    if (!ready || !authenticated) return "Start Learning Now";
    return user?.selectedLanguage ? "Continue Learning" : "Choose Your Language";
  }, [authenticated, ready, user]);
        ...
        <main>
            ...
            <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h1 className="hero-title display-lg mb-6">
                  Unlock the <br />
                  <span className="text-secondary">voices</span> of Africa.
                </h1>
                ...
                <p className="hero-text body-md text-gray-500 text-base md:text-lg leading-relaxed max-w-md mb-8">
                  ...
                  Connect deeply with a vibrant community of learners from
                  across the globe. Professional courses for real-world fluency.
                </p>
                ...
                <div className="hero-stats flex items-center gap-3">
                  ...
                  <p className="text-sm text-gray-500 font-medium">
                    <span className="font-black text-primary">2,500+</span>{" "}
                    learners joined this week
                  </p>
                </div>
              </div>
            ...
            <div className="container mx-auto px-6 max-w-6xl">
              <div className="text-center max-w-2xl mx-auto mb-16">
                <h2 className="text-3xl md:text-4xl font-extrabold mb-4 text-[#4A331A]">
                  Why Learn with <span className="text-on-surface">Afro</span>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="feature-card p-8 bg-white rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                  ...
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Go beyond vocabulary. Understand idioms, traditions, and
                    the cultural heartbeat behind every language.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="container mx-auto px-6 py-20 max-w-6xl">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-96 w-96 rounded-full bg-[#6a4a28] blur-[100px] pointer-events-none opacity-50" />
            </div>
          </section>
        </main>
